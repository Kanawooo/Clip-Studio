// Modified by Clip Studio: the upstream embedded PostHog project key was
// removed. Telemetry is disabled unless a user explicitly supplies their own
// HYPERFRAMES_POSTHOG_API_KEY.
//
...
const POSTHOG_API_KEY = process.env.HYPERFRAMES_POSTHOG_API_KEY?.trim() || "";
