...
export interface ProjectSkillRoots {
  clipSkills: string;
  hyperframes: string;
}

export function getProjectSkillRoots(projectRoot: string): ProjectSkillRoots {
  return {
...
export function isProjectSkillPath(filePath: string, roots: ProjectSkillRoots): boolean {
  return isUnderPath(filePath, roots.clipSkills) || isUnderPath(filePath, roots.hyperframes);
}

function isUnderPath(filePath: string, dir: string): boolean {
